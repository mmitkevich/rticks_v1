...
params <- data_frame(
  # limits
  limit.buy     = 16,  # buy when price <= buy only.  NA. +Inf = buy always.  -Inf = buy never
  stop.buy      = 10,    # FIXME: no buy lower than 18
  risk.buy      = 8,
...
bt_reports(r, save = F)
bt_plot(r, maxpoints = 1000, start = "2015-02-01", stop = "2015-07-01")

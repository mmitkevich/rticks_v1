...
params <- data_frame(
  # limits
  limit.buy     = 3.5,  # buy when price <= buy only.  NA. +Inf = buy always.  -Inf = buy never
  stop.buy      = 2.5,    # FIXME: no buy lower than 18
  risk.buy      = 2,
  ...
  symbol        = "NG.NYMEX",   # exante prefix of contract series

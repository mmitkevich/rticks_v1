...
params <- data_frame(
  # limits
  limit.buy     = 141,  # buy when price <= buy only.  NA. +Inf = buy always.  -Inf = buy never
  stop.buy      = 100,    # FIXME: no buy lower than 18
  risk.buy      = 90,
